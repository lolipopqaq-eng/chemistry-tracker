          ...
          substances: [
            ...
            },
            {
              ...
              reactions: [
                ...
                { id: 'r19', name: '卤代烃水解', equation: 'CH₃CH₂Br + NaOH →(H₂O/△) CH₃CH₂OH + NaBr', category: '有机', note: '水溶液，取代反应' },
                { id: 'r20', name: '卤代烃消去', equation: 'CH₃CH₂Br + NaOH →(醇/△) CH₂=CH₂↑ + NaBr + H₂O', category: '有机', note: '醇溶液，消去反应' },
                { id: 'r21', name: '油脂皂化', equation: '油脂 + NaOH →(△) 高级脂肪酸钠 + 甘油', category: '有机', note: '碱性水解' },
                { id: 'r22', name: '苯酚 + NaOH', equation: 'C₆H₅OH + NaOH →(常温) C₆H₅ONa + H₂O', category: '有机', phenomenon: '苯酚由浑浊变澄清', note: '酚羟基显弱酸性' },
                { id: 'r23', name: '酯的碱性水解', equation: "RCOOR' + NaOH →(H₂O/△) RCOONa + R'OH", category: '有机', note: '碱性条件下彻底水解' },
              ],
            },
            {
              id: 'ch2_na2co3',
