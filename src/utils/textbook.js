          ...
          substances: [
            {
              ...
              reactions: [
                { id: 'ch2_na1', name: 'Na + O₂（常温）', equation: '4Na + O₂ → 2Na₂O', category: '钠单质', note: '常温生成氧化钠（白色）' },
                { id: 'ch2_na2', name: 'Na + O₂（点燃）', equation: '2Na + O₂ →(点燃) Na₂O₂（淡黄色）', category: '钠单质', note: '点燃生成过氧化钠（淡黄色）' },
                { id: 'ch2_na3', name: 'Na + H₂O', equation: '2Na + 2H₂O → 2NaOH + H₂↑', category: '钠单质', note: '浮熔游响红，生成NaOH和H₂' },
            ...
            },
            {
              ...
              reactions: [
                { id: 'r01', name: '铝与氢氧化钠', equation: '2Al + 2NaOH + 2H₂O → 2NaAlO₂ + 3H₂↑', category: '单质反应', note: '重点反应，Al的两性体现' },
                ...
                { id: 'r13', name: '氧化铝与氢氧化钠', equation: 'Al₂O₃ + 2NaOH → 2NaAlO₂ + H₂O', category: '两性', note: 'Al₂O₃的两性' },
                { id: 'r14', name: '氢氧化铝与氢氧化钠', equation: 'Al(OH)₃ + NaOH → NaAlO₂ + 2H₂O', category: '两性', note: 'Al(OH)₃的两性，高考必考' },
                { id: 'r15', name: '铵盐制氨气', equation: 'NH₄Cl + NaOH → NaCl + NH₃↑ + H₂O', category: '复分解', note: '实验室制氨气' },
                ...
                { id: 'r19', name: '卤代烃水解（取代）', equation: 'CH₃CH₂Br + NaOH → CH₃CH₂OH + NaBr', category: '有机反应', note: '水溶液，取代反应' },
                ...
                { id: 'r23', name: '酯的碱性水解', equation: 'RCOOR\' + NaOH → RCOONa + R\'OH', category: '有机反应', note: '酯在碱性条件下彻底水解' },
              ],
            },
            {
              id: 'ch2_na2co3',
              ...
              reactions: [
                { id: 'n01', name: 'Na₂CO₃ + 盐酸少量', equation: 'Na₂CO₃ + HCl → NaHCO₃ + NaCl（无气泡）', category: '与酸反应', note: '逐滴加盐酸，先无气泡后出气泡' },
                { id: 'n02', name: 'Na₂CO₃ + 盐酸过量', equation: 'Na₂CO₃ + 2HCl → 2NaCl + H₂O + CO₂↑（有气泡）', category: '与酸反应', note: '盐酸过量直接出气泡' },
                { id: 'n03', name: 'Na₂CO₃ + Ca(OH)₂', equation: 'Na₂CO₃ + Ca(OH)₂ → CaCO₃↓ + 2NaOH', category: '与碱反应', note: '工业制烧碱' },
                { id: 'n04', name: 'Na₂CO₃ + Ba(OH)₂', equation: 'Na₂CO₃ + Ba(OH)₂ → BaCO₃↓ + 2NaOH', category: '与碱反应', note: '生成白色沉淀' },
            ...
            },
            {
              ...
              reactions: [
                ...
                { id: 'h02', name: 'NaHCO₃ + NaOH', equation: 'NaHCO₃ + NaOH → Na₂CO₃ + H₂O', category: '与强碱', note: '酸式盐遇碱变正盐' },
                ...
                { id: 'h09', name: 'Na₂CO₃→NaHCO₃', equation: 'Na₂CO₃ + CO₂ + H₂O → 2NaHCO₃', category: '相互转化', note: '通CO₂' },
                { id: 'h10', name: 'NaHCO₃→Na₂CO₃', equation: 'NaHCO₃ + NaOH → Na₂CO₃ + H₂O', category: '相互转化', note: '加碱' },
              ],
            },
          ],
        },
          ...
          substances: [
            {
              ...
              reactions: [
                { id: 'cl1', name: 'Cl₂ + Cu', equation: 'Cu + Cl₂ →(点燃) CuCl₂', category: '与金属', note: '棕黄色烟' },
                { id: 'cl2', name: 'Cl₂ + H₂', equation: 'H₂ + Cl₂ →(点燃) 2HCl', category: '与非金属', note: '苍白色火焰，瓶口白雾' },
                { id: 'cl3', name: 'Cl₂ + H₂O', equation: 'Cl₂ + H₂O ⇌ HCl + HClO', category: '与水', note: '氯水：浅黄绿色' },
                { id: 'cl4', name: 'Cl₂ + NaOH（制84）', equation: 'Cl₂ + 2NaOH → NaCl + NaClO + H₂O', category: '与碱', note: '制84消毒液' },
                { id: 'cl5', name: 'Cl₂ + Ca(OH)₂（制漂白粉）', equation: '2Cl₂ + 2Ca(OH)₂ → CaCl₂ + Ca(ClO)₂ + 2H₂O', category: '与碱', note: '制漂白粉' },
                { id: 'cl6', name: 'Cl₂ + Fe', equation: '2Fe + 3Cl₂ →(点燃) 2FeCl₃', category: '与金属', note: '生成FeCl₃（棕褐色烟）' },
                { id: 'cl7', name: 'Cl₂ + NaBr', equation: 'Cl₂ + 2NaBr → 2NaCl + Br₂', category: '置换反应', note: 'Cl₂氧化性>Br₂' },
            ...
            },
            {
              ...
              reactions: [
                { id: 'hclo1', name: 'HClO 光照分解', equation: '2HClO →(光照) 2HCl + O₂↑', category: '分解', note: '氯水需避光保存' },
              ],
            },
            {
              id: 'ch2_nacl',
              ...
              note: '白色晶体，易溶于水',
              reactions: [
                { id: 'nacl1', name: '电解饱和食盐水', equation: '2NaCl + 2H₂O →(电解) 2NaOH + H₂↑ + Cl₂↑', category: '电解', note: '氯碱工业' },
              ],
            },
          ],
        },
          ...
          substances: [
            {
              ...
              note: '银白色金属',
              reactions: [
                { id: 'fe1', name: 'Fe + O₂', equation: '3Fe + 2O₂ →(点燃) Fe₃O₄', category: '与氧气', note: '火星四射，生成Fe₃O₄' },
                { id: 'fe2', name: 'Fe + 稀酸', equation: 'Fe + 2H⁺ → Fe²⁺ + H₂↑', category: '与酸', note: '生成Fe²⁺（浅绿色）' },
                { id: 'fe3', name: 'Fe + 浓H₂SO₄/HNO₃', equation: 'Fe + 浓H₂SO₄/HNO₃ → 常温钝化', category: '与酸', note: '常温形成致密氧化膜' },
                { id: 'fe4', name: 'Fe + CuSO₄', equation: 'Fe + CuSO₄ → FeSO₄ + Cu', category: '置换反应', note: '湿法炼铜' },
                { id: 'fe5', name: 'Fe + Cl₂', equation: '2Fe + 3Cl₂ →(点燃) 2FeCl₃', category: '与非金属', note: '生成Fe³⁺（棕褐色烟）' },
            ...
            },
            {
              ...
              reactions: [
                { id: 'feo1', name: 'FeO + HCl', equation: 'FeO + 2HCl → FeCl₂ + H₂O', category: '与酸', note: 'FeO是碱性氧化物' },
                { id: 'feo2', name: 'Fe₂O₃ + HCl', equation: 'Fe₂O₃ + 6HCl → 2FeCl₃ + 3H₂O', category: '与酸', note: 'Fe₂O₃是碱性氧化物，铁红' },
                ...
                { id: 'feo5', name: 'Fe₂O₃ + Al（铝热反应）', equation: 'Fe₂O₃ + 2Al →(高温) 2Fe + Al₂O₃', category: '氧化还原', note: '铝热反应，焊接铁轨' },
              ],
            },
            {
              id: 'ch3_feoh',
              ...
              reactions: [
                { id: 'feoh1', name: 'Fe²⁺ + OH⁻', equation: 'Fe²⁺ + 2OH⁻ → Fe(OH)₂↓', category: '沉淀', note: '白色沉淀' },
                { id: 'feoh2', name: 'Fe³⁺ + OH⁻', equation: 'Fe³⁺ + 3OH⁻ → Fe(OH)₃↓', category: '沉淀', note: '红褐色沉淀' },
                { id: 'feoh3', name: 'Fe(OH)₂ 被氧化', equation: '4Fe(OH)₂ + O₂ + 2H₂O → 4Fe(OH)₃', category: '氧化', note: '白→灰绿→红褐，高考必考' },
